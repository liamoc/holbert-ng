...
type props1 = {term: SHOTerm.t, scope: array<string>, local_scope: array<string>, brackets: bool}
...
type props = {term: SHOTerm.t, scope: array<string>}
@react.componentWithProps
